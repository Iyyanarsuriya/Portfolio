...
- **Dark Background**: Dark slate shades (#0f172a - #1e293b)
- **Accent**: Cyan and blue gradients

## 📝 Customization

To customize the portfolio with your own information:

1. Update `src/data/portfolioData.js` with your personal information
